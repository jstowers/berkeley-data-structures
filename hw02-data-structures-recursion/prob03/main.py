...
# Fully implement the Deque data structure (you may choose either 
# a static or dynamic implementation) using an array.  
# Do not use any built-in methods except for the index operator. 
# Also, do not simply write a wrapper to the built-in Deque class.
